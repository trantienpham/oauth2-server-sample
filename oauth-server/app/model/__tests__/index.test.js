...
describe('Model', () => {
  describe('initDbConnectionAndModels()', () => {
    it('should initialize connection successful', (done) => {
      ...
      const clonedConfig = merge({database: {options: { logging: ()=>{}}}}, config);
  ...
  describe('createModels()', () => {
    ...
    describe('revokeAuthorizationCode()', () => {
      it('should return a promise', (done) => {
        ...
        const dbConnection = createDbConnection(clonedConfig);
        const model = createModels(dbConnection);
        const handler = model.revokeAuthorizationCode({authorizationCode: 'code'});
    ...
    describe('getUser()', () => {
      it('should return a promise', (done) => {
        ...
        const clonedConfig = merge({database: {options: { logging: ()=>{}}}}, config);
        const dbConnection = createDbConnection(clonedConfig);
        const salt = '$2b$12$65E6uaPdXdZhEzijgdfQyemCj9inE4ceO4NiCP3DV2fuT0E6lAm0q';
